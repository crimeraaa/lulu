...
USE_CONSTANT_FOLDING :: #config(LULU_USE_CONSTANT_FOLDING, !ODIN_DEBUG)
...
// Debug Info
DEBUG_TRACE_EXEC :: #config(LULU_DEBUG_TRACE_EXEC, ODIN_DEBUG)
DEBUG_PRINT_CODE :: #config(LULU_DEBUG_PRINT_CODE, ODIN_DEBUG)
