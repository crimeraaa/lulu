...
int luaO_log2 (unsigned int x) {
  /**
   * @brief
   *    Maps `x` to `log(x=x+1, base=2)`, because `log2(0)` is invalid.
   *    So `log_2[0]` actually refers to `log(x=1, base=2)`.
   */
  static const lu_byte log_2[256] = {
    0,1,2,2,3,3,3,3, /* [0:8]   = x in [1, 9)  */
    4,4,4,4,4,4,4,4, /* [8:16]  = x in [9, 17) */
    5,5,5,5,5,5,5,5, /* [16:24] = x in [17, 25) */
    5,5,5,5,5,5,5,5, /* [24:32] = x in [25, 33) */
