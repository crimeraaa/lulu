...
#define getcode(fs,e)	((fs)->proto->code[(e)->u.s.info])
...
LUAI_FUNC void luaK_dischargevars (FuncState *func, Expr *e);
LUAI_FUNC int luaK_exp2anyreg (FuncState *func, Expr *e);
LUAI_FUNC void luaK_exp2nextreg (FuncState *func, Expr *e);
LUAI_FUNC void luaK_exp2val (FuncState *func, Expr *e);
LUAI_FUNC int luaK_exp2RK (FuncState *func, Expr *e);
LUAI_FUNC void luaK_self (FuncState *func, Expr *e, Expr *key);
LUAI_FUNC void luaK_indexed (FuncState *func, Expr *t, Expr *k);
LUAI_FUNC void luaK_goiftrue (FuncState *func, Expr *e);
...
LUAI_FUNC void luaK_setoneret (FuncState *func, Expr *e);
