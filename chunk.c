...
void disassemble_chunk(Chunk *self, const char *name) {
    ...
    for (int offset = 0; offset < (int)self->count;) {
 ...
 */
static int opconst(const char *name, const Chunk *self, int offset) {
...
static DWord read_byte3(const Chunk *self, int offset) {
 ...
 */
static int oplconst(const char *name, const Chunk *self, int offset) {
...
static int opsimple(const char *name, int offset) {
    printf("%s\n", name);
 ...
 */
static int opbyte(const char *name, const Chunk *self, int offset) {
...
int disassemble_instruction(Chunk *self, int offset) {
    printf("0x%04x ", offset); // Print number left-padded with 0's
