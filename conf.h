...
/* This is the default stack-allocated size of the REPL's char buffer. We prefer 
stack-allocated over heap-allocated because it's easier to manage. Although it's 
limiting, for most users 256 characters should be well beyond reasonable. */
 ...
 */
#define LUA_MAXSTACK        (LUA_MAXFRAMES * LUA_MAXFRAMES)
...
/* Most user-facing operations in Lua use double-precision floating point values.
